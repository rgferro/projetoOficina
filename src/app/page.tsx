...
export default function LandingPage() {
  ...
  return (
    <div className="space-y-24 pb-20 font-sans text-slate-900 selection:bg-blue-600 selection:text-white">
      ...
      {/* 🌟 6. DEPOIMENTOS REAIS (PROVA SOCIAL PROFUNDA) */}
      <section className="max-w-5xl mx-auto space-y-8">
        <div className="text-center space-y-2 max-w-2xl mx-auto">
          ...
          <h2 className="text-2xl sm:text-4xl font-black text-slate-900 tracking-tight">
            O que os donos de oficina dizem sobre o Torque ERP
          </h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white p-6 rounded-3xl border border-slate-200 shadow-sm space-y-4">
            ...
            <p className="text-xs text-slate-700 italic leading-relaxed">
              "O aviso automático no WhatsApp quando o carro fica pronto mudou meu negócio. Meus clientes adoraram e o telefone parou de tocar a cada 5 minutos!"
            </p>
            <div className="flex items-center gap-3 pt-2 border-t border-slate-100">
              ...
              <div>
                <div className="font-bold text-xs text-slate-900">Marcos Santana</div>
                <div className="text-[10px] text-slate-500">Auto Mecânica Santana • SP</div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white p-6 rounded-3xl border border-slate-200 shadow-sm space-y-4">
            ...
            <p className="text-xs text-slate-700 italic leading-relaxed">
              "Antes eu usava caderninho e planilha no Excel que vivia dando erro. Agora com o Torque ERP controlo o pátio do lava-jato no celular e o caixa fecha certinho todo dia."
            </p>
            <div className="flex items-center gap-3 pt-2 border-t border-slate-100">
              <div className="w-9 h-9 rounded-full bg-cyan-600 text-white flex items-center justify-center font-bold text-xs">
                RO
              </div>
              <div>
                <div className="font-bold text-xs text-slate-900">Rodrigo Oliveira</div>
                <div className="text-[10px] text-slate-500">Lava-Jato & Estética Express • MG</div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white p-6 rounded-3xl border border-slate-200 shadow-sm space-y-4">
            ...
            <p className="text-xs text-slate-700 italic leading-relaxed">
              "O checklist com foto de avaria já me salvou de 2 clientes que falaram que o risco foi feito na oficina. Mostrei a foto tirada na entrada e pronto. Vale cada centavo."
            </p>
            <div className="flex items-center gap-3 pt-2 border-t border-slate-100">
              ...
              <div>
                <div className="font-bold text-xs text-slate-900">Fernando Almeida</div>
                <div className="text-[10px] text-slate-500">Centro Automotivo CarPro • PR</div>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* ❓ 7. QUEBRA DE OBJEÇÕES (FAQ INTERATIVO) */}
