  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-slate-500">
            Cadastre clientes, vincule múltiplos veículos e acesse o histórico de serviços e lava-jato.
          </p>
        </div>
      ...
      <div className="relative">
        ...
        <input
          type="text"
          placeholder="Buscar por Nome do Cliente, WhatsApp, CPF ou Placa do Veículo..."
          value={search}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {customers.map((c) => (
            <div
              ...
              className="bg-white rounded-2xl border border-slate-200/90 p-5 shadow-sm hover:shadow-md hover:border-blue-300 transition-all cursor-pointer flex flex-col justify-between"
            >
              <div>
                ...
                <div className="mt-4 pt-3 border-t border-slate-100 flex flex-wrap gap-1.5">
                  {c.vehicles.map((v: any) => (
                    <span
                      key={v.id}
                      className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg bg-blue-50 text-blue-800 text-[11px] font-bold border border-blue-200"
                    >
                      <Car className="w-3 h-3 text-blue-600" />
                      <span className="font-mono">{formatPlate(v.plate)}</span>
                      <span className="text-slate-500 font-normal">({v.model})</span>
                    </span>
                  ))}
                </div>
              </div>
              ...
              <div className="mt-4 pt-3 border-t border-slate-100 flex items-center justify-between text-xs text-blue-600 font-semibold">
                <span>Ver ficha completa & histórico</span>
