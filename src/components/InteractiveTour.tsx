...
export const TOUR_STEPS: TourStep[] = [
  ...
  },
  {
    ...
    route: "/financeiro",
    content:
      "Controle completo de caixa e fluxo financeiro: abertura de turno com fundo de troco, sangrias (retiradas para despesas), suprimentos (entradas de troco), baixa de contas a pagar/receber e extrato consolidado de todas as entradas de PDV, OS e Lava-Jato.",
    tips: [
      "Abra o turno de caixa informando o fundo de troco inicial do dia.",
      "Lance sangrias com comprovante do motivo (ex: peças urgentes ou almoço).",
      "Controle contas a pagar de fornecedores com data de vencimento e quitação com 1 clique.",
    ],
    actionLabel: "Acessar Caixa & Financeiro",
  },
  {
    id: "clientes",
    title: "7. Gestão de Clientes & Veículos (Frota)",
    subtitle: "Histórico completo de atendimentos, placas e contatos",
    icon: Users,
    badge: "Base de Clientes",
    badgeColor: "bg-blue-100 text-blue-800 border-blue-300",
    route: "/clientes",
    content:
      "Cadastro centralizado de clientes (Pessoa Física e Jurídica) e vinculação de múltiplos veículos por cliente. Consulte histórico de ordens de serviço anteriores, histórico de lavagens, quilometragem acumulada e dados para contato direto no WhatsApp.",
    tips: [
      "Busque instantaneamente por placa, nome, CPF/CNPJ ou telefone.",
      "Cadastre múltiplos veículos para o mesmo cliente mantendo históricos separados.",
      "Acesse a ficha cadastral do cliente para ver todas as OS e manutenções já executadas.",
    ],
    actionLabel: "Ver Clientes & Veículos",
  },
  {
    id: "fornecedores",
    title: "8. Fornecedores & Distribuidores de Peças",
    subtitle: "Controle de distribuidores, marcas e contas a pagar",
    icon: Truck,
    badge: "Fornecedores",
    badgeColor: "bg-amber-100 text-amber-800 border-amber-300",
    route: "/fornecedores",
    content:
      "Cadastre distribuidoras de autopeças, fornecedores de lubrificantes, produtos de estética e ferramentas. Mantenha salvo dados de contato do vendedor, chave PIX para pagamentos e vincule diretamente no contas a pagar e nas notas XML.",
    tips: [
      "Salve a chave PIX do vendedor ou distribuidor para agilizar sangrias e pagamentos.",
      "Localize fornecedores rapidamente por razão social, nome fantasia ou CNPJ.",
      "Vincule faturas de fornecedores com o módulo financeiro para nunca atrasar boletos.",
    ],
    actionLabel: "Ver Fornecedores",
  },
  {
    id: "crm",
    title: "9. CRM & WhatsApp Marketing Automático",
    subtitle: "Fidelização e retorno inteligente de clientes ausentes",
    icon: MessageSquare,
    badge: "CRM & Fidelização",
    badgeColor: "bg-rose-100 text-rose-700 border-rose-300",
    route: "/crm",
    content:
      "Aumente o faturamento trazendo os clientes de volta: disparo de lembrete de troca preventiva de óleo (a cada 6 meses), lembrete de lavagem para clientes sumidos (+15 dias) e cupons promocionais de aniversário via WhatsApp oficial em segundo plano.",
    tips: [
      "Dispare mensagens no WhatsApp oficial em 1 clique sem precisar digitar nada.",
      "O sistema detecta automaticamente o tempo desde o último serviço ou lavagem.",
      "Mensagens personalizadas com nome do cliente, placa e modelo do veículo.",
    ],
    actionLabel: "Explorar CRM WhatsApp",
  },
  {
    id: "relatorios",
    title: "10. Relatórios Estratégicos & Business Intelligence",
    subtitle: "Curva ABC de produtos, comissões e aniversariantes",
    icon: BarChart3,
    badge: "BI & Indicadores",
    badgeColor: "bg-violet-100 text-violet-800 border-violet-300",
    route: "/relatorios",
    content:
      "Métricas essenciais para tomada de decisão da sua oficina: Curva ABC de produtos mais lucrativos, apuração de comissões por colaborador (mecânicos e lavadores), relatório de itens em estoque crítico e aniversariantes do mês para ações de marketing.",
    tips: [
      "Analise os produtos Classe A que representam 70% do seu faturamento.",
      "Apure comissões de mecânicos e lavadores com base nas OS concluídas do mês.",
      "Envie mensagens de feliz aniversário no WhatsApp com desconto em 1 clique.",
    ],
    actionLabel: "Acessar Relatórios & BI",
  },
  {
    id: "assinatura",
    title: "11. Assinatura, Planos & Assentos de Usuários",
    subtitle: "Gestão do plano SaaS, upgrades e pagamento via PIX/Cartão",
    icon: CreditCard,
    badge: "Planos & Assinatura",
    badgeColor: "bg-emerald-100 text-emerald-800 border-emerald-300",
    route: "/assinatura",
    content:
      "Gerencie o plano da sua oficina (Starter Grátis, Pro ou Elite), acompanhe a quantidade de assentos de colaboradores ativos, realize upgrades instantâneos via PIX Copia e Cola automático ou Cartão de Crédito com ativação imediata.",
    tips: [
      "Upgrade para Pro ou Elite libera múltiplos usuários, leitor de código de barras e CRM.",
      "Pagamentos via PIX são aprovados na hora sem necessidade de comprovante manual.",
      "Adicione assentos extras conforme sua equipe for crescendo.",
    ],
    actionLabel: "Ver Planos & Assinatura",
  },
  {
    id: "equipe",
    title: "12. Controle de Login, Usuários & Permissões",
    ...
    tips: [
      ...
      "Envie convites por e-mail ou defina senhas diretamente pelo painel.",
    ],
    actionLabel: "Gerenciar Equipe & Permissões",
  },
  {
    id: "backup",
    title: "13. Ajustes da Oficina, WhatsApp & Backup",
    subtitle: "Segurança máxima dos dados e conexão oficial do WhatsApp",
    icon: Cloud,
    badge: "Proteção & Ajustes",
    badgeColor: "bg-sky-100 text-sky-700 border-sky-300",
    route: "/configuracoes",
    content:
      "Configure o nome, CNPJ e endereço da oficina para impressão nas ordens de serviço. Conecte o WhatsApp lendo o QR Code para disparos automáticos e crie backups de segurança em nuvem para proteger todas as informações.",
    tips: [
      "Gere backups manuais ou ative a sincronização em nuvem.",
      "Personalize modelos de mensagens de WhatsApp com variáveis dinâmicas {nome} e {veiculo}.",
    ],
